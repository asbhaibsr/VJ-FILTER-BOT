...
auth_channel = environ.get('AUTH_CHANNEL', '-1002892671107') # give your force subscribe channel id here else leave it blank
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/GdE.jpg') # payment code picture url.
